...
public class WaveCircleView extends View implements ValueAnimator.AnimatorUpdateListener{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newWidthAndHeight = Math.min(width,height);
        setMeasuredDimension(newWidthAndHeight,newWidthAndHeight);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mStartY = mStartMinY;
        mCirclePath.addCircle(w/2,h/2,w/2, Path.Direction.CW);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawColor(Color.parseColor("#3500FF00"));
        mPath.reset();
